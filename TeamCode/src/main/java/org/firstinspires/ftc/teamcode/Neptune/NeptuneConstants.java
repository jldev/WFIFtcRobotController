...
public class NeptuneConstants {
    ...
    public static double NEPTUNE_INTAKE_SERVO_P5 = .6;
    ...
    public static int NEPTUNE_SLIDE_MOTOR_POS_TOLERANCE = 100;
    ...
    public static double NEPTUNE_WANTED_DISTANCE_FROM_BACKDROP = 3;
