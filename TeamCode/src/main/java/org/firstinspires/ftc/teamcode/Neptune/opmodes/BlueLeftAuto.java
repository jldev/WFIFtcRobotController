...
public class BlueLeftAuto extends CommandOpMode {
...
//                                    new TrajectoryFollowerCommand(neptune.drive, trajectories.getTrajectory(new Pose2d(-12,0))),
                                    ...
                                    new TrajectoryFollowerCommand(neptune.drive, trajectories.getTrajectory(new Pose2d (-38, -62, Math.toRadians(0)))
